...
export const PatientRegistrationForm: React.FC<PatientRegistrationFormProps> = ({
  ...
  const exportMealPlanToPDF = () => {
    ...
    doc.text('Generated by UNTH Plastic Surgery PWA', pageWidth / 2, footerY, { align: 'center' });
  ...
  const generateConsultationLetterPDF = (assessmentType: 'dvt' | 'pressureSore' | 'nutritional') => {
    ...
    doc.text(`Generated: ${new Date().toLocaleString('en-NG')} | UNTH Plastic Surgery PWA`, pageWidth / 2, footerY, { align: 'center' });
  ...
  const generatePatientEducationPDF = (assessmentType: 'dvt' | 'pressureSore' | 'nutritional') => {
    ...
    doc.setFontSize(8);
    doc.text(`Generated: ${new Date().toLocaleString('en-NG')} | UNTH Plastic Surgery PWA`, pageWidth / 2, pageHeight - 11, { align: 'center' });
  ...
  const generateCarePlanPDF = () => {
    ...
    doc.setFontSize(8);
    doc.setFont('helvetica', 'normal');
    doc.text(`Generated: ${new Date().toLocaleString('en-NG')} | UNTH Plastic Surgery PWA`, pageWidth / 2, pageHeight - 9, { align: 'center' });
